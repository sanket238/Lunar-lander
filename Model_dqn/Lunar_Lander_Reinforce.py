...
from Lunar_Lander_AI import Network  # The Network class is defined in the AI module
...
class ReplayMemory(object):
    ...
    def sample(self, batch_size):
        ...
        # Convert and move data to PyTorch tensors on the specified device
...
class Agent():
    def __init__(self, state_size, action_size):
        ...
        # Adam optimizer for the local Q-network
        self.optimizer = optim.Adam(self.local_qnetwork.parameters(), lr=learning_rate)
        # Experience replay memory
        self.memory = ReplayMemory(replay_buffer_size)
        # Time step for updating the network
        self.t_step = 0

    def step(self, state, action, reward, next_state, done):
        # Store the experience in replay memory and periodically update the network
